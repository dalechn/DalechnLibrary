...
#region 异常上报
        ...
        #if UNITY_WEBGL && !UNITY_EDITOR
        [DllImport("__Internal")]
        private static extern bool WXCleanAllFileCache();
        #else
        private static bool WXCleanAllFileCache() { return true; }
        #endif

                                                                                            #region 文件缓存清理
                                                                                            public bool CleanAllFileCache()
                                                                                            {
                                                                                            return WXCleanAllFileCache();
                                                                                            }
                                                                                            #endregion
