	...
	namespace Math
	{
		public static partial class Distance
		{
			...
			public static float Segment2Segment2(ref Segment2 segment0, ref Segment2 segment1)
			{
				...
				return Mathf.Sqrt(SqrSegment2Segment2(ref segment0, ref segment1, out closestPoint0, out closestPoint1));
			}
			...
			{
				Vector2 closestPoint0, closestPoint1;
				return SqrSegment2Segment2(ref segment0, ref segment1, out closestPoint0, out closestPoint1);
			}
