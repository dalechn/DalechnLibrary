		...
		public static partial class Intersection
		{
			...
			public static bool TestRay2Triangle2(ref Ray2 ray, ref Triangle2 triangle, out IntersectionTypes intersectionType)
			{
				...
				else
				{
					...
					{
						float w0, w1;
						int quantity = Intersection.FindSegment1Segment1(param0, param1, 0f, float.PositiveInfinity, out w0, out w1);
			...
			public static bool FindRay2Triangle2(ref Ray2 ray, ref Triangle2 triangle, out Ray2Triangle2Intr info)
			{
				...
				else
				{
					...
					{
						float w0, w1;
						info.Quantity = Intersection.FindSegment1Segment1(param0, param1, 0f, float.PositiveInfinity, out w0, out w1);
