	...
	namespace Math
	{
		...
		public static partial class Intersection
		{
			private static IntersectionTypes Classify(ref Line2 line0, ref Line2 line1, out float s0)
			{
				...
				Vector2 originDiff = line1.Center - line0.Center;

				s0 = 0f;

				float D0DotPerpD1 = line0.Direction.DotPerp(line1.Direction);

				if (Mathf.Abs(D0DotPerpD1) > _dotThreshold)
				{
					// Lines intersect in a single point.

					float diffDotPerpD1 = originDiff.DotPerp(line1.Direction);
				...
				float diffNDotPerpD1 = originDiff.DotPerp(line1.Direction);
