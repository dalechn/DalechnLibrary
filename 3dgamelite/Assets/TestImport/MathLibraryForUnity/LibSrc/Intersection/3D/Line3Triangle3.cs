	...
	namespace Math
	{
		...
		public static partial class Intersection
		{
			...
			public static bool TestLine3Triangle3(ref Line3 line, ref Triangle3 triangle, out IntersectionTypes intersectionType)
			{
				...
				Vector3 diff   = line.Center - triangle.V0;
				...
				float DdN = line.Direction.Dot(normal);
				float sign;
				...
				float DdQxE2 = sign * line.Direction.Dot(diff.Cross(edge2));
				if (DdQxE2 >= -Mathfex.ZeroTolerance)
				{
					float DdE1xQ = sign * line.Direction.Dot(edge1.Cross(diff));
