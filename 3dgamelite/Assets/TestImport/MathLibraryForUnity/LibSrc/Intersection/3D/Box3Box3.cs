	...
	namespace Math
	{
		public static partial class Intersection
		{
			...
			public static bool TestBox3Box3(ref Box3 box0, ref Box3 box1)
			{
				...
				float cutoff = 1.0f - Mathfex.ZeroTolerance;
				bool existsParallelPair = false;

				// Convenience variables.
				Vector3 A0 = box0.Axis0;
				Vector3 A1 = box0.Axis1;
				Vector3 A2 = box0.Axis2;
				Vector3 B0 = box1.Axis0;
				Vector3 B1 = box1.Axis1;
				Vector3 B2 = box1.Axis2;
				
				float EA0 = box0.Extents.x;
				float EA1 = box0.Extents.y;
				float EA2 = box0.Extents.z;
				float EB0 = box1.Extents.x;
				float EB1 = box1.Extents.y;
				float EB2 = box1.Extents.z;

				// Compute difference of box centers, D = C1-C0.
				Vector3 D = box1.Center - box0.Center;

				float C00, C01, C02, C10, C11, C12, C20, C21, C22;								// matrix C = A^T B, c_{ij} = Dot(A_i,B_j)
				float AbsC00, AbsC01, AbsC02, AbsC10, AbsC11, AbsC12, AbsC20, AbsC21, AbsC22;	// |c_{ij}|
				float AD0, AD1, AD2;	// Dot(A_i,D)
