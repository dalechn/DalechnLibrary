	...
	namespace Math
	{
		...
		public static partial class Intersection
		{
			...
			public static bool FindLine3Polygon3(ref Line3 line, Polygon3 polygon, out Line3Polygon3Intr info)
			{
				...
				float DdN = line.Direction.Dot(plane.Normal);
				float signedDistance = plane.SignedDistanceTo(ref line.Center);
				if (Mathf.Abs(DdN) > _dotThreshold)
				{
					...
					Vector2 projectedPoint = point.ToVector2(projectionPlane);
