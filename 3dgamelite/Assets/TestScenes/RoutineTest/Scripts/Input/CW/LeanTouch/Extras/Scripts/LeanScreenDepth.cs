                    ...
                    case ConversionType.AutoDistance:
                        {
                            if (gameObject != null)
                            {
                                //Vector3 pos1 = camera.ScreenToViewportPoint(screenPoint);
                                //Vector3 pos2 = camera.WorldToViewportPoint(gameObject.transform.position);
                                //position = camera.ViewportToWorldPoint(new Vector3(pos1.x, pos1.y, pos2.z));
