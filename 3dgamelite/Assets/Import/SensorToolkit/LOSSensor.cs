    ...
    public class LOSSensor : Sensor, IPulseRoutine {
        ...
        public ILOSResult TestSignal(Signal inputSignal) {
            ...
            var testConfig = new BaseLOSTest.ConfigParams {
                ...
                OwnedColliders = GetInputColliders(inputSignal.Object, clist),
                ...
                MaxHorizAngle = MaxHorizAngle,
                VisibilityByHorizAngle = VisibilityByHorizAngle,
                MaxVertAngle = MaxVertAngle,
                VisibilityByVertAngle = VisibilityByVertAngle
            };
