...
namespace Micosmo.SensorToolkit {
    ...
    public static partial class SensorGizmos {
        ...
        public static readonly Color GizmoColor = new Color(51 / 255f, 255 / 255f, 255 / 255f);
        public static readonly Color CastShapeColor = Color.green;
        public static readonly Color GizmoBlockedColor = Color.red;
        public static readonly Color GizmoNormalColor = Color.yellow;

        public static Color[] VisibilityGradientColours {
            get {
                if (visibilityGradientColours == null) {
                    visibilityGradientColours = ParseHexColours(new string[] {
                        "#33ffff",
                        "#35ffbc",
                        "#36ff79",
                        "#38ff38",
                ...
                return visibilityGradientColours;
            }
        }
        static Color[] visibilityGradientColours;
