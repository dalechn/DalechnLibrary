...
namespace CJTools
{
    public class bl_UpdateManager : MonoBehaviour
    {
        ...
        public static DoAction RunAction(string actName , float duration, ED_Void_FF stepCall, ED_Void overCall = null, EaseType type = EaseType.Lerp, ActionMode mode = ActionMode.MUpdate)
        {
        ...
        public static DoAction RunAction(string actName, float duration, float delay, ED_Void_FF stepCall, ED_Void onceCall = null, ED_Void overCall = null, EaseType type = EaseType.Lerp, ActionMode mode = ActionMode.MUpdate)
        {
            DoAction s = new DoAction();
            s.mode = mode;
            s.easeType = type;
        ...
        public static DoAction RunActionOnce(string actName, float delay, ED_Void onceCall, EaseType type = EaseType.Lerp, ActionMode mode = ActionMode.MUpdate)
        {
            DoAction s = new DoAction();
            s.mode = mode;
            s.easeType = type;
