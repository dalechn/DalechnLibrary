...
public static class ExtensionTransform
{
    ...
    public static GameObject GetOneLvGameObject(this Transform trans)
    {
        return trans.parent.gameObject;
    }

    public static GameObject GetTwoLvGameObject(this Transform trans)
    {
        return trans.parent.parent.gameObject;
    }
}
