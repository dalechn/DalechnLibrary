...
namespace Invector.vCharacterController
{
    ...
    public class vHeadTrack : vMonoBehaviour
    {
        ...
        protected vIAnimatorStateInfoController animatorStateInfo;
        ...
        protected vHeadTrackSensor sensor;
        protected float interation;
        protected vICharacter vchar;
        protected float yAngle, xAngle;
        protected float _yAngle, _xAngle;
        protected Transform forwardReference;
        #endregion
        public float Smooth
        {
            get
