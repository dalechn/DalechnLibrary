...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vTriggerGenericAction : vMonoBehaviour
    {
        ...
        [Tooltip("Time you have to hold the button *Only for GetButtonTimer*")]
        public float buttonTimer = 3f;
        [Tooltip("Add delay to start the input count *Only for GetButtonTimer*")] 
        public float inputDelay = 0.1f;
        [Tooltip("*Only for GetButtonTimer* \n\n<b>TRUE: </b> Play the animation while you're holding the button \n" +
            "<b>FALSE: </b>Play the animation after you finish holding the button")]
        public bool playAnimationWhileHoldingButton = true;
        
        [Tooltip("Time to press the button twice *Only for GetDoubleButton*")]
        public float doubleButtomTime = 0.25f;

        [vEditorToolbar("Trigger", order = 2)]
        public string actionName = "Action";
        public string actionTag = "Action";
        [Tooltip("Disable this trigger OnStart")]
        public bool disableOnStart = false;
        [Tooltip("Disable the Player's Capsule Collider Collision, useful for animations with closer interactions")]
        public bool disableCollision;
        [Tooltip("Disable the Player's Rigidbody Gravity, useful for on air animations")]
        public bool disableGravity;
        [Tooltip("It will only use the trigger if the forward of the character is close to the forward of this transform")]
        public bool activeFromForward;
        [Tooltip("Max angle between character forward and trigger forward to active trigger"), Range(5, 180)]
        public float forwardAngle = 55;
        [Tooltip("Rotate Character to the Forward Rotation of this Trigger")]
        public bool useTriggerRotation;
        [Tooltip("Destroy this Trigger after pressing the Input or AutoAction or finishing the Action")]
        public bool destroyAfter = false;
        [vHideInInspector("destroyAfter")]
        public float destroyDelay = 0f;
        [Tooltip("Change your CameraState to a Custom State while playing the animation")]
        public string customCameraState;

        [vEditorToolbar("Animation", order = 2)]

        [Tooltip("Trigger a Animation - Use the exactly same name of the AnimationState you want to trigger, " +
        ...
        [Tooltip("Use a ActionState value to apply special conditions for your AnimatorController transitions")]
        public int animatorActionState = 0;
        [Tooltip("Reset the ActionState parameter to 0 after playing the animation")]
        public bool resetAnimatorActionState = true;        
        [Tooltip("Use a empty transform as reference for the MatchTarget")]
        public Transform matchTarget;
        [Tooltip("Select the bone you want to use as reference to the Match Target")]       
