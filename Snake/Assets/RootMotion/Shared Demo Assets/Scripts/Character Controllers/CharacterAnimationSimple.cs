...
namespace RootMotion.Demos {
	...
	public class CharacterAnimationSimple: CharacterAnimationBase {
		...
		void Update() {
            ...
            Vector3 moveDir = characterController.transform.right * characterController.animState.moveDirection.x
                + characterController.transform.forward * characterController.animState.moveDirection.z;
            //Vector3 moveDir= characterController.userControl.state.move;
