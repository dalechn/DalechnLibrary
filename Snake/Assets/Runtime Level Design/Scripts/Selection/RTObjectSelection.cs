...
namespace RLD
{
    ...
    public class RTObjectSelection : MonoSingleton<RTObjectSelection>
    {
        ...
        private List<GameObject> _overlappedObjectBuffer = new List<GameObject>();
        ...
        private void OnInputDevicePickButtonUp()
        {
            ...
            if (!RTScene.Get.IsAnySceneEntityHovered() && RTFocusCamera.Get.IsViewportHoveredByDevice() &&
                !RTGizmosEngine.Get.JustReleasedDrag)
            {
                // Can we click select?
        ...
        private void PerformMultiSelect()
        {
            ...
            _multiSelectShape.GetOverlappedObjects(_visibleObjectBuffer, RTFocusCamera.Get.TargetCamera, boundsQConfig, Settings.MultiSelectOverlapMode, _overlappedObjectBuffer);
            ...
            {
                var overlappedObjects = DoPreDeselectCustomize(_overlappedObjectBuffer, ObjectDeselectReason.MultiDeselect);
            ...
            {
                var potentialList = FilterByRestrictions(_overlappedObjectBuffer, SelectRestrictFlags.All, ObjectSelectReason.MultiSelectAppend);
            ...
            else
            {
                ...
                var potentialList = FilterByRestrictions(_overlappedObjectBuffer, SelectRestrictFlags.All, ObjectSelectReason.MultiSelect);
        ...
        private void PerformClickSelect()
        {
            ...
            RTScene.Get.RaycastAllObjectsSorted(ray, SceneRaycastPrecision.BestFit, _objectHitBuffer);

            var filteredHits = FilterByRestrictions(_objectHitBuffer, SelectRestrictFlags.All);
