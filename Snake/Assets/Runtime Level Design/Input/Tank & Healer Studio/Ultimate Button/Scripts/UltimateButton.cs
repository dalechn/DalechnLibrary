...
[ExecuteInEditMode]
#if ENABLE_INPUT_SYSTEM
public class UltimateButton : OnScreenControl, IPointerDownHandler, IDragHandler, IPointerUpHandler, IPointerEnterHandler,IPointerExitHandler
#else
public class UltimateButton : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, IPointerEnterHandler,IPointerExitHandler
#endif
{
	...
	public void OnPointerDown ( PointerEventData touchInfo )
	{
		...
		if( !IsInRange( touchInfo.position ) &&!usingSlide)
			return;
