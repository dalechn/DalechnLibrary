...
namespace Dest
{
	namespace Math
	{
		...
		public struct AAB3
		{
			...
			{
				vertex0 = Min;
				vertex1 = new Vector3(Max.x, Min.y, Min.z);
				vertex2 = new Vector3(Max.x, Max.y, Min.z);
				vertex3 = new Vector3(Min.x, Max.y, Min.z);
				vertex4 = new Vector3(Min.x, Min.y, Max.z);
				vertex5 = new Vector3(Max.x, Min.y, Max.z);
				vertex6 = Max;
				vertex7 = new Vector3(Min.x, Max.y, Max.z);
			}
			...
			public void CalcVertices(Vector3[] array)
			{
				...
				array[2] = new Vector3(Max.x, Max.y, Min.z);
				array[3] = new Vector3(Min.x, Max.y, Min.z);
				array[4] = new Vector3(Min.x, Min.y, Max.z);
