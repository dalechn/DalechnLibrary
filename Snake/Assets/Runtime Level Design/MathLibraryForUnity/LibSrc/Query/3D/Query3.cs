...
using Vector3Real = UnityEngine.Vector3;
...
namespace Dest
{
	namespace Math
	{
		internal class Query3 : Query
		{
			...
			private Vector3Real[] _vertices;

			public Query3(Vector3Real[] vertices)
			{
				_vertices = vertices;
			}
			...
			public int ToPlane(ref Vector3Real test, int v0, int v1, int v2)
			{
				bool positive = Sort(ref v0, ref v1, ref v2);

				Vector3Real vec0 = _vertices[v0];
				Vector3Real vec1 = _vertices[v1];
				Vector3Real vec2 = _vertices[v2];
			...
			public int ToTetrahedron(ref Vector3Real test, int v0, int v1, int v2, int v3)
			{
			...
			public int ToCircumsphere(ref Vector3Real test, int v0, int v1, int v2, int v3)
			{
