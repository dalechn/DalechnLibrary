        ...
        public class CustomInspector : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                if (meshRenderer != null || meshFilter != null)
                {
                    ...
                    {
                        EditorGUILayout.HelpBox("Error. This GameObject already has a Mesh Filter/Renderer. Please add Runtime Combiner to a GameObject that does not have these components.", UnityEditor. MessageType.Error);
                        return;
                    }
                }
                ...
                if (script.targetMeshes.Count == 0)
                    EditorGUILayout.HelpBox("Oops! No GameObjects with meshes was registered to be combined! If you want to subscribe any, click the button below!", UnityEditor.MessageType.Info);
                if (script.targetMeshes.Count > 0)
                ...
                if (script.showDebugLogs == true)
                    EditorGUILayout.HelpBox("Excessive debug logs can cause performance fluctuations in your game. Just enable this function while debugging your merge and game.", UnityEditor.MessageType.Warning);
