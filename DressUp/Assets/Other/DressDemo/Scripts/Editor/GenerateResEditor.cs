...
{
    private const string ANIM_PATH = "Assets/GirlTest/Anims/";
    private const string MAT_PATH = "Assets/GirlTest/Materials/";
    private const string Prefab_PATH = "Assets/GirlTest/Resources/";
    ...
    private static void GeneratePrefab(GameObject srcobj, string dir, string middir)
    {
        ...
        {
            // *用这个函数创建的是根节点的prefab不是smr.gameObject,猜测:这个函数的参数只能是asset文件夹里的资源?
            ...
            // *删除用InstantiatePrefab创建出来的GameObject
