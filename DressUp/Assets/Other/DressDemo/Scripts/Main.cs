...
public class Main : MonoBehaviour
{
    ...
    private const string ANIM_PATH = "Assets/DressDemo/Anims/";
    private const string MAT_PATH = "Assets/DressDemo/Materials/";
    private const string Prefab_PATH = "Assets/DressDemo/Resources/";
    private void CreateAllAvatarRes()
    {
        DirectoryInfo dir = new DirectoryInfo(Prefab_PATH);
        foreach(var subdir in dir.GetDirectories())
        {
            ...
            string animpath = ANIM_PATH + dirname + "/";
